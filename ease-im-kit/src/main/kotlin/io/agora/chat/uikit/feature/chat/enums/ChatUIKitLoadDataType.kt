 ...
 */
enum class ChatUIKitLoadDataType {
    /**
...
internal fun ChatUIKitLoadDataType.isShouldStackFromEnd(): Boolean {
    return this != ChatUIKitLoadDataType.THREAD && this != ChatUIKitLoadDataType.SEARCH
}