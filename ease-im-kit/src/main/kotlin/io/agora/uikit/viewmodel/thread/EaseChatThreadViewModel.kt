package io.agora.uikit.viewmodel.thread
...
class EaseChatThreadViewModel: EaseBaseViewModel<IChatThreadResultView>(),IChatThreadRequest {
    ...
    private val groupRepository by lazy { EaseGroupRepository() }
            ...
            flow {
                ...
                .collect {
                    _conversation?.conversationId()?.let { conversationId ->
                        EaseThreadNotifyHelper.removeCreateThreadNotify(
    ...
    companion object {
        private val TAG = EaseChatThreadViewModel::class.java.simpleName
