package io.agora.uikit.feature.chat.forward.helper
 ...
 */
class EaseChatMessageMultiSelectHelper private constructor() {
    ...
    companion object {
        @Volatile
        private var instance: EaseChatMessageMultiSelectHelper? = null

        fun getInstance(): EaseChatMessageMultiSelectHelper {
            if (instance == null) {
                synchronized(EaseChatMessageMultiSelectHelper::class.java) {
                    if (instance == null) {
                        instance = EaseChatMessageMultiSelectHelper()
                    }
                }
            }
            return instance!!
