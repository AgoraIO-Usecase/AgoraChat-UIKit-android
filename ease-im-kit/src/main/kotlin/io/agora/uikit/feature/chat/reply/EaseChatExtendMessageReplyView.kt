package io.agora.uikit.feature.chat.reply
...
import io.agora.uikit.databinding.EaseWidgetChatMessageReplyBinding
import io.agora.uikit.feature.chat.interfaces.IChatTopExtendMenu
import io.agora.uikit.feature.chat.reply.interfaces.IChatMessageReply
import io.agora.uikit.feature.chat.reply.interfaces.IChatMessageReplyResultView
import io.agora.uikit.viewmodel.reply.EaseChatMessageReplyViewModel
...
class EaseChatExtendMessageReplyView(
    ...
    init {
        ...
        viewModel = if (context is ViewModelStoreOwner) {
            ViewModelProvider(context)[EaseChatMessageReplyViewModel::class.java]
        } else {
            EaseChatMessageReplyViewModel()
        }
    ...
    override fun showQuoteMessageAttachment(
        ...
        when(type) {
            ...
            ChatMessageType.COMBINE ->{
                binding.quoteIcon.setImageResource(R.drawable.ease_chat_quote_icon_combine)
            }
            else -> {
                binding.quoteIcon.visibility = GONE
            }
