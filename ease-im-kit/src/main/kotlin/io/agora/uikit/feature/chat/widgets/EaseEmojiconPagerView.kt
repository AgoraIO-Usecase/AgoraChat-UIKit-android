...
import io.agora.uikit.databinding.EaseChatEmojiExpressionGridviewBinding
import io.agora.uikit.feature.chat.adapter.EaseChatEmojiGridAdapter
import io.agora.uikit.feature.chat.adapter.EmojiconPagerAdapter
...
import io.agora.uikit.widget.EaseDividerGridItemDecoration
...
class EaseEmojiconPagerView @JvmOverloads constructor(
    ...
    fun getGroupGridViews(groupEntity: EaseEmojiconGroupEntity): List<View> {
        var emojiconList: List<EaseEmojicon> = groupEntity.emojiconList?.filterNotNull() ?: mutableListOf()
        val emojiType = groupEntity.type
        val views: MutableList<View> = ArrayList()

        // Set viewPager's item view
        val pageViewBinding = EaseChatEmojiExpressionGridviewBinding.inflate(LayoutInflater.from(context))
        ...
        val gridAdapter = EaseChatEmojiGridAdapter()
        pageViewBinding.gridview.adapter = gridAdapter
        pageViewBinding.gridview.addItemDecoration(EaseDividerGridItemDecoration(context, R.drawable.ease_chat_emoji_expression_gridview_divider))
        ...
        gridAdapter.setOnItemClickListener(object : OnItemClickListener {
            override fun onItemClick(view: View?, position: Int) {
                ...
                emojicon?.run {
                    if (emojiText == EaseEmojiHelper.DELETE_KEY) {
