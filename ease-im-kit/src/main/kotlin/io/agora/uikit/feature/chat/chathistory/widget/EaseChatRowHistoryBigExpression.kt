...
import io.agora.uikit.widget.chatrow.EaseChatRowBigExpression

/**
 * big emoji icons
 *
 */
open class EaseChatRowHistoryBigExpression @JvmOverloads constructor(
    private val context: Context,
    private val attrs: AttributeSet? = null,
    private val defStyleAttr: Int = 0,
    isSender: Boolean = false
) : EaseChatRowBigExpression(context, attrs, defStyleAttr, isSender) {
