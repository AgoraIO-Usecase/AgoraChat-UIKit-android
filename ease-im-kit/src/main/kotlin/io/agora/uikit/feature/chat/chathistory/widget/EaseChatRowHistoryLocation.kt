...
import io.agora.uikit.widget.chatrow.EaseChatRowLocation

/**
 * location row
 */
open class EaseChatRowHistoryLocation @JvmOverloads constructor(
    private val context: Context,
    private val attrs: AttributeSet? = null,
    private val defStyleAttr: Int = 0,
    isSender: Boolean = false
) : EaseChatRowLocation(context, attrs, defStyleAttr, isSender) {
