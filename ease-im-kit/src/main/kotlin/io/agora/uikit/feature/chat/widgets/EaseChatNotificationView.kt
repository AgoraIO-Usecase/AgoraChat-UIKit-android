...
import io.agora.uikit.feature.chat.interfaces.IChatNotification

class EaseChatNotificationView @JvmOverloads constructor(
    ...
    private fun showNotificationView() {
        if (notificationView == null) {
            notificationView = EaseUnreadNotificationView(context)
        }
