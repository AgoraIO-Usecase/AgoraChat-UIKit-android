...
class EaseSwitchItemView @JvmOverloads constructor(
    context: Context,
    ...
    fun init(context: Context, attrs: AttributeSet?) {
        root = LayoutInflater.from(context).inflate(R.layout.ease_layout_item_switch, this)
    ...
    private fun setListener() {
        switch?.setOnCheckedChangeListener { buttonView, isChecked ->
            if (listener != null) {
                listener?.onCheckedChanged(this@EaseSwitchItemView, isChecked)
            }
        }
    }
    ...
    interface OnCheckedChangeListener {
         ...
         */
        fun onCheckedChanged(buttonView: EaseSwitchItemView?, isChecked: Boolean)
    }
