...
class EaseArrowItemView @JvmOverloads constructor(
    ...
    fun init(context: Context, attrs: AttributeSet?) {
        ...
        val subTitleResourceId = a.getResourceId(R.styleable.EaseArrowItemView_arrowItemSubTitle, -1)
        subTitle = a.getString(R.styleable.EaseArrowItemView_arrowItemSubTitle)
        if (subTitleResourceId != -1) {
            subTitle = getContext().getString(subTitleResourceId)
        }
        tvSubTitle?.text = subTitle
        val subTitleColorId = a.getResourceId(R.styleable.EaseArrowItemView_arrowItemSubTitleColor, -1)
        subTitleColor = a.getColor(
            R.styleable.EaseArrowItemView_arrowItemSubTitleColor,
        ...
        val showSubTitle = a.getBoolean(R.styleable.EaseArrowItemView_arrowItemShowSubTitle, false)
        tvSubTitle?.visibility = if (showSubTitle) VISIBLE else GONE
        val subTitleStyle = a.getInteger(R.styleable.EaseArrowItemView_arrowItemSubTitleStyle, -1)
        setTvStyle(subTitleStyle)
        val subTitleSizeId = a.getResourceId(R.styleable.EaseArrowItemView_arrowItemSubTitleSize, -1)
        subTitleSize =
            a.getDimension(R.styleable.EaseArrowItemView_arrowItemSubTitleSize, sp2px(getContext(), 14f))
        if (titleSizeId != -1) {
