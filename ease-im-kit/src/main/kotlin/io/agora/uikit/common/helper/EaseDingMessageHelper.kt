 ...
 */
class EaseDingMessageHelper internal constructor(context: Context) {
    /**
...
//        }
    ...
    companion object {
        private const val TAG = "EaseDingMessageHelper"
        ...
        private var instance: EaseDingMessageHelper? = null
        fun get(): EaseDingMessageHelper {
            if (instance == null) {
                synchronized(EaseDingMessageHelper::class.java) {
                    if (instance == null) {
                        instance = EaseDingMessageHelper(ChatClient.getInstance().context)
                    }
                }
            }
            return instance!!
