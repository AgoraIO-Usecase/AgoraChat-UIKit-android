 ...
 */
class EaseFlowLayout @JvmOverloads constructor(
    ...
    private fun initAttr(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        val a = context.obtainStyledAttributes(attrs, R.styleable.EaseFlowLayout, defStyleAttr, 0)
        alignToRight = a.getBoolean(R.styleable.EaseFlowLayout_alignRight, false)
        horizontalSpace = a.getDimensionPixelSize(R.styleable.EaseFlowLayout_horizontalMargin, 0)
        a.recycle()
    }
    ...
    abstract class Adapter<VH: ViewHolder> {
        ...
        open fun onAttachedToRecyclerView(view: EaseFlowLayout) {}
        open fun onDetachedFromRecyclerView(view: EaseFlowLayout) {}
    ...
    open abstract class EaseFlowAdapter<T, VH: ViewHolder>: Adapter<VH>() {
