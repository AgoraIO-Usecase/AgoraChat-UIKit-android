...
import io.agora.chat.uikit.adapter.EaseBaseRecyclerViewAdapter.ViewHolder;
...
//                    }
                ...
                return isChat ? ((ChatMessage) item).direct().toString() : EaseAdapterDelegate.DEFAULT_TAG;
            }
