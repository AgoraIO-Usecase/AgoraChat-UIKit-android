...
public class EaseChatMessageMultiSelectHelper {
    ...
    /**
     * Add conversationId for combine message.
     * @param conversationId
     */
    public void addToConversationId(String conversationId) {
        toSendUserIds.add(conversationId);
    }

    /**
     * Determines whether the conversationId is contained.
     * @param conversationId
     * @return
     */
    public boolean isContainsConversationId(String conversationId) {
        return toSendUserIds.contains(conversationId);
    }

    /**
     * Get the conversation list for sending combine message.
     * @return
     */
    public List<String> getToConversationList() {
        return new ArrayList<>(toSendUserIds);
    }
